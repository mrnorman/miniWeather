...
on the kernels themselves. For your OpenACC parallel loop constructs,
you must either explicitly write your own copy, copyin, and copyout
clauses for all arrays used in the kernel, or you must write ``default(present)''
to tell the compiler not to worry about the data. Otherwise, it will
complain that it doesn't know how big the arrays are. Other than this,
the approach is the same as with the Fortran case. 
