...
INTEGER (C_INT64_T ), PARAMETER :: NX = 4000
INTEGER (C_INT64_T ), PARAMETER :: NZ = 2000
REAL (C_DOUBLE ), PARAMETER :: DX = 5.0
REAL (C_DOUBLE ), PARAMETER :: DZ = 5.0
...
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(IN) :: recvbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(IN) :: recvbuf_r
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(OUT) :: state
...
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(IN) :: state
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(OUT) :: sendbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(OUT) :: sendbuf_r
...
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(IN) :: state
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(IN) :: statetmp
REAL (C_DOUBLE ), DIMENSION(1:4001, 1:2001, 1:4), INTENT(IN) :: flux
REAL (C_DOUBLE ), DIMENSION(1:4000, 1:2000, 1:4), INTENT(IN) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:2002), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:2002), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:2001), INTENT(IN) :: hy_dens_int
REAL (C_DOUBLE ), DIMENSION(1:2001), INTENT(IN) :: hy_dens_theta_int
REAL (C_DOUBLE ), DIMENSION(1:2001), INTENT(IN) :: hy_pressure_int
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(IN) :: sendbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(IN) :: sendbuf_r
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(IN) :: recvbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:2000, 1:4), INTENT(IN) :: recvbuf_r
...
REAL (C_DOUBLE ), DIMENSION(-1:2002), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), DIMENSION(-1:2002), INTENT(IN) :: hy_dens_theta_cell
REAL (C_DOUBLE ), DIMENSION(1:4001, 1:2001, 1:4), INTENT(OUT) :: flux
REAL (C_DOUBLE ), DIMENSION(1:4000, 1:2000, 1:4), INTENT(OUT) :: tend
...
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(IN) :: state_init
REAL (C_DOUBLE ), DIMENSION(1:4000, 1:2000, 1:4), INTENT(INOUT) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:2002), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), INTENT(IN) :: dt
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(OUT) :: state_out
...
REAL (C_DOUBLE ), DIMENSION(-1:4002, -1:2002, 1:4), INTENT(INOUT) :: state
REAL (C_DOUBLE ), DIMENSION(-1:2002), INTENT(IN) :: hy_dens_cell
