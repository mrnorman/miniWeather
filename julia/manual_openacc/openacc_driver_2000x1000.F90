...
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(IN) :: recvbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(IN) :: recvbuf_r
REAL (C_DOUBLE ), DIMENSION(-1:2002, -1:1002, 1:4), INTENT(OUT) :: state
...
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(OUT) :: sendbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(OUT) :: sendbuf_r
...
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(IN) :: sendbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(IN) :: sendbuf_r
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(IN) :: recvbuf_l
REAL (C_DOUBLE ), DIMENSION(1:2, 1:1000, 1:4), INTENT(IN) :: recvbuf_r
...
REAL (C_DOUBLE ), DIMENSION(-1:2002, -1:1002, 1:4), INTENT(IN) :: state_init
REAL (C_DOUBLE ), DIMENSION(1:2000, 1:1000, 1:4), INTENT(INOUT) :: tend
REAL (C_DOUBLE ), DIMENSION(-1:1002), INTENT(IN) :: hy_dens_cell
REAL (C_DOUBLE ), INTENT(IN) :: dt
REAL (C_DOUBLE ), DIMENSION(-1:2002, -1:1002, 1:4), INTENT(OUT) :: state_out
...
REAL (C_DOUBLE ), DIMENSION(-1:2002, -1:1002, 1:4), INTENT(INOUT) :: state
REAL (C_DOUBLE ), DIMENSION(-1:1002), INTENT(IN) :: hy_dens_cell
