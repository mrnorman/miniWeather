...
** In all cases, the relative mass change printed out should be at machine precision (`1.e-12` or lower just to be flexible with reduced precision optimizations). If the mass changes more than this, you've introduced a bug. **
