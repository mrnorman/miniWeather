...
contains
  ...
  subroutine set_halo_values_x(state)
    ...
    real(rp), allocatable :: sendbuf_l(:,:,:)
    real(rp), allocatable :: sendbuf_r(:,:,:)
    real(rp), allocatable :: recvbuf_l(:,:,:)
    real(rp), allocatable :: recvbuf_r(:,:,:)
  ...
  subroutine reductions( state , mass , te )
    implicit none
    real(rp), intent(in   ) :: state(1-hs:,1-hs:,:)
